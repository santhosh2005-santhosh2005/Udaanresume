...
import { t as Route } from "./login-BuHeNv-t.mjs";
import { t as SocialAuth } from "./social-auth-B_dyO1M1.mjs";
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormField, {
						...
						render: ({ field }) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(FormItem, { children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(FormLabel, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trans, { id: "8ZsakT" }) }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
									asChild: true,
									tabIndex: -1,
									variant: "link",
