...
import { M as a, Y as r } from "../_libs/phosphor-icons__react.mjs";
...
import { d as InputGroupAddon, f as InputGroupButton, m as InputGroupText, p as InputGroupInput, u as InputGroup } from "./combobox-DqfXinLv.mjs";
...
var buttonGroupVariants = cva("flex w-fit items-stretch *:focus-visible:relative *:focus-visible:z-10 has-[>[data-slot=button-group]]:gap-2 has-[select[aria-hidden=true]:last-child]:[&>[data-slot=select-trigger]:last-of-type]:rounded-r-md [&>[data-slot=select-trigger]:not([class*='w-'])]:w-fit [&>input]:flex-1", {
	variants: { orientation: {
		horizontal: "[&>*:not(:first-child)]:rounded-l-none [&>*:not(:first-child)]:border-s-0 [&>*:not(:last-child)]:rounded-r-none [&>[data-slot]:not(:has(~[data-slot]))]:rounded-r-md!",
...
function Slider$1({ className, defaultValue, value, min = 0, max = 100, ...props }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Root, {
		...
		min,
		max,
		className: cn("relative flex w-full touch-none select-none items-center data-vertical:h-full data-vertical:min-h-40 data-vertical:w-auto data-vertical:flex-col data-disabled:opacity-50", className),
		...props,
...
var $$splitComponentImporter = () => import("./route-DaZ1P9lf.mjs");
var Route = createFileRoute("/builder/$resumeId")({
	...
	head: ({ loaderData }) => ({ meta: loaderData ? [{ title: `${loaderData.name} - UdaanResume` }] : void 0 })
});
