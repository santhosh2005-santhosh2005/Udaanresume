...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CFuL_VRl.mjs");
...
var manifest = {
	...
	"4cf8a2dd9971804ed852b0e8800e0801d53148f92b5cde984ecc2402a068ba3c": {
		...
		importer: () => import("./route-D46b0w-3.mjs")
	},
	...
	"756c704a65dc0d34a819db91bfae51022d981bb53c6ad8906dba70c85f0a9c84": {
		...
		importer: () => import("./resumes-y2iYoRoV.mjs")
	},
	...
	"513aca5e0aecd5ef992128f5d4c9f895e12f04155f3f4abd4b56c78ca99ffe64": {
		...
		importer: () => import("./functions-tyzJH21P.mjs")
	},
...
async function loadEntries() {
	const routerEntry = await import("./router-BGRli59_.mjs");
	return {
		startEntry: await import("./start-D9UR12Ca.mjs"),
		routerEntry
	};
}
function getEntries() {
...
async function getBaseAdapter(options, handleDirectDatabase) {
	...
	if (!options.database) {
		...
		const { memoryAdapter } = await import("./dist-c_nRL7yO.mjs");
		...
		hooks: { after: [{
			...
			handler: createAuthMiddleware(async (ctx) => {
				...
				if (returned instanceof Headers) {
					...
					const { setCookie } = await import("./server-lASydYio.mjs");
