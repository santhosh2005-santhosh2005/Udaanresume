...
import { a as DialogHeader, i as DialogFooter, n as DialogContent, o as DialogTitle, r as DialogDescription } from "./dialog-BDn2oyE5.mjs";
import { t as Input } from "./input-CV38K_Qt.mjs";
import { t as Spinner } from "./spinner-D1lc23Qp.mjs";
import { s as defaultResumeData, w as templateSchema, x as resumeDataSchema } from "./data-f2IXU9X_.mjs";
import { t as generateId } from "./string-bvNQE4dt.mjs";
import { r as client, u as orpc } from "./client-B0hja1xN.mjs";
import { n as toast } from "../_libs/sonner.mjs";
import { t as useAIStore } from "./store-ByqK0kkm.mjs";
...
import { r as parseRgbString } from "./color-C4dfgEFA.mjs";
...
var extractTextFromPdf = async (file) => {
	const pdfjs = await import("../_libs/_9.mjs");
...
var extractTextFromDocx = async (file) => {
	const mammoth = await import("../_libs/_8.mjs").then((m) => /* @__PURE__ */ __toESM(m.default));
	const arrayBuffer = await file.arrayBuffer();
