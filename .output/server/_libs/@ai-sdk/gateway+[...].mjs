...
var require_get_vercel_oidc_token = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	async function getVercelOidcToken() {
		...
		try {
			const [{ getTokenPayload, isExpired }, { refreshToken }] = await Promise.all([await import("../_6.mjs").then((m) => /* @__PURE__ */ __toESM(m.default)), await import("../_7.mjs").then((m) => /* @__PURE__ */ __toESM(m.default))]);
