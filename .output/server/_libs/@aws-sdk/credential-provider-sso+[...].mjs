...
import { $ as getSSOTokenFilepath, Jt as init_dist_es, Q as getSSOTokenFromFile, X as loadSsoSessionData, Xt as TokenProviderError, Y as parseKnownFiles, Zt as CredentialsProviderError, et as getProfileName, q as init_dist_es$1, qt as require_client } from "./client-s3+[...].mjs";
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
	const { SSOOIDCClient } = await import("../_14.mjs").then((m) => /* @__PURE__ */ __toESM(m.default));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
	const { CreateTokenCommand } = await import("../_14.mjs").then((m) => /* @__PURE__ */ __toESM(m.default));
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger }) => {
	...
	const { SSOClient, GetRoleCredentialsCommand } = await import("../_11.mjs");
...
export { validateSsoProfile as n, isSsoProfile as r, fromSSO as t };
