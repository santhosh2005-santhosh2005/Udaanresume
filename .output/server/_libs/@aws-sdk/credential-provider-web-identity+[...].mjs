...
import { J as externalDataInterceptor, Jt as init_dist_es, Zt as CredentialsProviderError, q as init_dist_es$1, qt as require_client } from "./client-s3+[...].mjs";
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
	...
	if (!roleAssumerWithWebIdentity) {
		const { getDefaultRoleAssumerWithWebIdentity } = await import("../_15.mjs").then((m) => /* @__PURE__ */ __toESM(m.default));
