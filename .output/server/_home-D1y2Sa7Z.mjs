...
import { t as CometCard } from "./_ssr/comet-card-Dxbil5WR.mjs";
...
var Templates = (0, import_react.lazy)(() => import("./_ssr/templates-Uvq5yqXQ.mjs").then((m) => ({ default: m.Templates })));
var Footer = (0, import_react.lazy)(() => import("./_ssr/footer-D1SCxu-V.mjs").then((m) => ({ default: m.Footer })));
